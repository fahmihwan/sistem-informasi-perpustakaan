...
@section('styles')
    <link rel="stylesheet" href="{{ asset('assets/css/dataTablesJquery.css') }}">
...
@section('container')
    <div class="container px-6 mx-auto grid">
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs mt-4">
            <div class="w-full overflow-x-auto p-4 text-white bg-purple-600 drop-shadow-md">
                List Tahun Terbit
            </div>
            <div class="w-full overflow-x-auto p-4">
                <table class="w-full whitespace-no-wrap mt-10  " id="dataTable">
                    <thead>
                        <tr
                            class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                            <th class="py-3">No</th>
                            <th class="py-3">Tahun Terbit</th>
                            <th class="py-3">Create at</th>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class=" py-3 text-sm ">
                                <div class="flex items-center space-x-4 text-sm">
                                    <button style="background-color: #ffc106"
